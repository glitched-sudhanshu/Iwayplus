...
import com.example.iwayplus.model.utils.hasLocationPermission
...
class DefaultLocationClient(
    ...
    override fun getLocationUpdates(interval: Long): Flow<Location> {
        //callback flow is used if you have a callback that you want to transform to a flow
        return callbackFlow {
            ...
            val isNetworkEnabled = locationManger.isProviderEnabled(LocationManager.NETWORK_PROVIDER)
